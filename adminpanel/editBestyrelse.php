    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file mr-sm-2 mb-2">
                            ...
                            <label class="custom-file-label" id="customFileText" for="customFile">Vælg fil</label>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger">Gem</button>
            </div>
        </div>
    </div>
</div>
    ...
    function editRow(ele){
        ...
        $.post("bestyrelse/bestyrelseHandler.php",
            ...
            function(data){
                ...
                $('#customFileText').text(infomation['picture_path']);
                $('#hiddenID').val(infomation['id']);
            });
    }
